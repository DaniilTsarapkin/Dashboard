...
const GROUP_META = [
  { id: 1, icon: '⚡', name: 'Поток и трение' },
  { id: 2, icon: '🧠', name: 'Когнитивная нагрузка' },
  { id: 3, icon: '🛡', name: 'Безопасность' },
  { id: 4, icon: '💬', name: 'Культура' },
  { id: 5, icon: '🏢', name: 'Орг. здоровье' },
]
          ...
          <div className="bg-gray-900 rounded-xl p-4">
            ...
            {(role === 'Engineering Manager' || role === 'Admin') && (
              <div className="mt-4 pt-3 border-t border-gray-800">
                <div className="text-xs text-gray-500">M15 Онбординг</div>
